...
const menuItems = [
  ...
  { id: '6', category: 'Desserts', name: 'Cheesecake', price: '₱140', desc: 'Creamy cheesecake with a buttery graham crust.' },
  { id: '7', category: 'Desserts', name: 'Brownie', price: '₱90', desc: 'Rich chocolate brownie with a soft and fudgy center.' },
  { id: '8', category: 'Desserts', name: 'Chocolate Cake', price: '₱150', desc: 'Moist chocolate cake topped with sweet chocolate frosting.' },
];
...
export default function App() {
  return (
    <NavigationIndependentTree>
      ...
      >
        <Stack.Screen name="Menu" component={HomeScreen} options={{ title: '☕ Lucky Beans' }} />
        <Stack.Screen name="Detail" component={DetailScreen} options={{ title: 'Coffee Details', headerLeft: () => null }} />
      </Stack.Navigator>
    </NavigationIndependentTree>
  );
